...
import { DifferentiatorsContent, DifferentiatorHighlight } from '../../../../core/models/home';
...
export class DashboardDifferentiatorsSectionComponent {
  ...
  @Input() sectionId = 'differentiators';
  ...
  private createHighlight(): DifferentiatorHighlight {
    return { label: '', value: '' };
  }
}
